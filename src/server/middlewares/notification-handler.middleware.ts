...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'task.create': {
    roles: ['franchise-admin', 'basic-user'],
    key: 'task-assigned',
    tenantPath: ['organization', 'task'],
    userPath: [],
  },
  'task.update': {
  ...
  'message.create': { roles: ['super-admin', 'franchise-admin'], key: 'new-message', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['franchise-admin'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['franchise-admin', 'basic-user'];
