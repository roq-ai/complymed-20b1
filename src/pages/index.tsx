  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="ComplyMED: Streamlining Compliance Management. Simplify, visualize, and actionize tasks to meet regulations and laws. Secure communication and personalized task allocation for your business needs."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`ComplyMED: Streamlining Compliance Management. Simplify, visualize, and actionize tasks to meet regulations and laws. Secure communication and personalized task allocation for your business needs.`}
            </Text>
            <Box
            ...
            >
              <Stack direction="column" spacing={6}>
                <Card userTypeName="Franchise Admin" type="franchise-admin" />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
